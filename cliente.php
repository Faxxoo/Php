        ...
        <div class="cliente-layout">
            ...
            <div>
                ...
                <div class="glass-card pedido-card <?php echo $i===0?'selected':''; ?>"
                    ...
                    <?php endif; ?>
                    <?php if ($p['estadoentrega'] === 'Entregado'): ?>
                    <div style="margin-top:0.8rem;">
                        <a href="generar_qr.php?idVenta=<?php echo $p['idventa']; ?>"
                           target="_blank"
                           style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.45rem 1rem;border-radius:8px;background:linear-gradient(135deg,rgba(99,102,241,0.2),rgba(6,182,212,0.2));border:1px solid rgba(99,102,241,0.4);color:#a5b4fc;font-size:0.8rem;font-weight:600;text-decoration:none;transition:all 0.2s;"
                           onmouseover="this.style.background='linear-gradient(135deg,rgba(99,102,241,0.35),rgba(6,182,212,0.35))'"
                           onmouseout="this.style.background='linear-gradient(135deg,rgba(99,102,241,0.2),rgba(6,182,212,0.2))'">
                            📱 Ver QR / Recibo
                        </a>
                    </div>
                    <?php endif; ?>
            ...
            <div style="position:sticky;top:1.5rem;">
                ...
                <div class="glass-card" style="padding:0;overflow:hidden;">
                    ...
                    <div id="mapa-cliente" style="height: 400px;px;width:100%;background:#0a0f1e;display:flex;align-items:center;justify-content:center;">
