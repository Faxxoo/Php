...
<head>
    ...
    <style>
        #mapa-admin { height:240px; width:100%; }
        .map-wrap { padding:0; overflow:hidden; margin-bottom:1.5rem; }
        .map-wrap-header { padding:0.8rem 1.2rem; border-bottom:1px solid rgba(255,255,255,0.07); display:flex; justify-content:space-between; align-items:center; }
        /* Botones navbar más compactos */
        .nav-btn-sm {
...
<div class="app-wrapper">
    ...
    <nav class="navbar">
        ...
        <div class="nav-user">
            ...
            <?php if ($esAdmin): ?>
            <a href="graficos.php" class="btn nav-btn-sm" style="width:auto;background:rgba(59,130,246,0.2);color:#60a5fa;border:1px solid rgba(59,130,246,0.5);">📊 Gráficos</a>
            <a href="admin_productos.php" class="btn nav-btn-sm" style="width:auto;background:rgba(34,197,94,0.2);color:#4ade80;border:1px solid rgba(34,197,94,0.5);">📦 Productos</a>
            <a href="admin_trabajadores.php" class="btn nav-btn-sm" style="width:auto;background:rgba(245,158,11,0.2);color:#fbbf24;border:1px solid rgba(245,158,11,0.5);">👥 Trabajadores</a>
            <a href="diagnostico.php" class="btn nav-btn-sm" style="width:auto;background:rgba(168,85,247,0.2);color:#c084fc;border:1px solid rgba(168,85,247,0.5);" title="Diagnóstico del sistema">🔧 Diagnóstico</a>
            <?php endif; ?>
            <a href="logout.php" class="btn nav-btn-sm" style="width:auto;background:rgba(239,68,68,0.2);color:var(--danger);border:1px solid rgba(239,68,68,0.5);">Cerrar Sesión</a>
        </div>
    </nav>
